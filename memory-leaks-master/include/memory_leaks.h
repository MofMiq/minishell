...
/*   Updated: 2023/08/28 14:27:42 by marirodr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define malloc(X) ft_alloc_ja(X, __FILE__, __LINE__, __FUNCTION__, NULL, 0)
# define calloc(X, Y) ft_alloc_ja(X * Y, __FILE__, __LINE__, __FUNCTION__, NULL, 1)
# define free(X) ft_alloc_ja(0, __FILE__, __LINE__, __FUNCTION__, X, 2)
...
void		*ft_alloc_ja(size_t size, const char *file, int line,
